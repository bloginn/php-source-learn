...
#else
# define PG(v) (core_globals.v) /* PHP的全局变量 */
...
struct _php_core_globals {
	...
	zend_bool register_argc_argv;/* 是否将 E, G, P, C, S 变量注册为全局变量 */
	...
	signed char always_populate_raw_post_data;/* 是否总是生成$HTTP_RAW_POST_DATA变量(原始POST数据) */
